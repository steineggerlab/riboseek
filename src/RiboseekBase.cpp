...
std::vector<Command> riboseekCommands = {
    ...
    {"rnafold", rnafold, &localPar.rnafold, COMMAND_SEQUENCE,
            "Predict RNA secondary structure with an internal thermodynamic fold",
            "riboseek rnafold queryDB structureDB\n",
            "Martin Steinegger <martin.steinegger@snu.ac.kr>",
            "<i:queryDB> <o:structureDB>",
            CITATION_MMSEQS2, {{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                      {"structureDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::genericDb }}},
